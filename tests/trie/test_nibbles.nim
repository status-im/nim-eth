...
suite "Nibbles":
  ...
  test "slice must clear last limb":
    let
      xx = NibblesBuf.fromBytes(
        hexToSeqByte"1111111111111111111111111111111111111111111111111111111111111111"
      )
      yy = NibblesBuf.fromBytes(
        hexToSeqByte"1111111111111111111111111111111111111111111111111111111111111110"
      )
